...
namespace ApiClient
{
    public class ApiGetClient
    {
        ...
        public static async Task<T> PostAsyncApiClient<T>(string path, string contentObj)
        {
            T output = default(T);
        ...
        public async static Task<string> PostApiClient(string path, object contentObj)
        {
